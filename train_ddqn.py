...
def main():
    ...
    ap.add_argument("--wall_obstacles", action="store_true",default=False)
    ...
    ap.add_argument("--eps_end", type=float, default=0.04)
    ap.add_argument("--eps_decay_steps", type=int, default=200000)
    ap.add_argument("--seed", type=int, default=6767)
    args = ap.parse_args()
